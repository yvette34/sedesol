						...
						<form action="insertarPersonal.php" method="POST" name="from">
							<div class="container">
								...
								<div class="form-group col-md-7">  
									...
									<input type="text"   class="form-control validateText" id="apellido_p"  placeholder="Introduzca apellido paterno" name="apellido_p" required> 
								</div>
								<div class="form-group col-md-7">  
									<label for="apellido_m">Apellido Materno:</label>
									<input type="text"   class="form-control validateText" id="apellido_m" placeholder="Inroduzca apellido materno" name="apellido_m" required> 
								</div>
								<div class="form-group col-md-7">
