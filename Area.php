                          ...
                          <div class="container">
                            <form action="insertarArea.php" method="POST" name="from">
                              ...
                              <div class="form-group col-md-7">  
                                ...
                                <input type="text"   class="form-control validateText" id="nombre_area" placeholder="Introduzca el nombre de área" name="nombre_area" required> 
                              </div>

                              <div class="form-group col-md-7">  
                                <label for="nombre">Número de Extensión:</label>
                                <input type="text"   class="form-control validateNumber" id="ext" placeholder="Introduzca el número de extensión"   name="ext" required> 
                              </div>
